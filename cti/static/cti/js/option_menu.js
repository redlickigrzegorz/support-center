$(document).ready(function() {
    $('.fault-tr').click(function(event) {
        let option_modal = $("#options-modal");
        option_modal.width("0px");
        option_modal.show();
        ...
        if (header === gettext('resolved faults')) {
            content = $('<div class="options-menu">'+
        ...
        option_modal.html(content).offset({ top: event.pageY, left: event.pageX}).animate({width: "160px"});
    });
    ...
    $('.user-tr').click(function(event) {
        ...
        let content = $('<div class="options-menu">'+
