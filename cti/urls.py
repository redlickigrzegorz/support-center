...
urlpatterns = [
    ...
    url(r'^delete_fault_mobile/(?P<fault_id>[0-9]+)/$', views.delete_fault_mobile, name='delete_fault_mobile'),
    url(r'^assign_fault_mobile/(?P<fault_id>[0-9]+)/$', views.assign_to_me_mobilei, name='assign_to_me_mobilei'),
